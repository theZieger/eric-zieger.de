...
import { footer, address, column, title, icon } from "./Footer.module.css"

export default function Footer() {
  return (
    <footer className={"layout-block " + footer} role="contentinfo">
      <div>
        <div className={address}>
          ...
          <div className={column}>
            <h2 className={title}>Socialize</h2>
            <ul>
              <li>
                <a
              ...
              <li>
                ...
                >
                  <svg className={icon} viewBox="0 0 24 24">
                    <path d="M20 3H4a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h16a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3zM4 5h16c.4 0 .7.2.9.6L12 11.8 3.1 5.6c.2-.4.5-.6.9-.6zm16 14H4c-.6 0-1-.4-1-1V7.9l8.4 5.9.6.2.6-.2L21 7.9V18c0 .6-.4 1-1 1z"></path>
                  </svg>
                  Drop me an email
                </a>
              </li>
